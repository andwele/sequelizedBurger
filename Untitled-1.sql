/*
*Files* `Top1000Songs.csv` or `Top5000Songs.csv`
> _Top1000Songs.csv.zipshould only be used if when you try to import Top5000Songs.csv.zip, your computer crashes_
