...
var userPrototype = Object.getPrototypeOf(user); // __proto__
...
var newObject = {
    name: "I'm a new object..."
}
console.log('----------')
var newObjectPrototype = Object.getPrototypeOf(newObject);
console.log(Object.getOwnPropertyNames(newObjectPrototype))

newObject.introduce();
// ...Et voila.
user.introduce();

userPrototype.introduce();